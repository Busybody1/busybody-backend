...
exports.calculateCalorieIntake = exports.calculateWeightLossLength = exports.calculateTDEE = exports.calculateBMI = void 0;
...
const calculateTDEE = (req, res) => {
    const { weight, height, age, activityLevel, gender = 'female', heightUnit = 'cm', weightUnit = 'kg' } = req.body;
...
const calculateWeightLossLength = (req, res) => {
...
exports.calculateWeightLossLength = calculateWeightLossLength;
const calculateCalorieIntake = (req, res) => {
...
exports.calculateCalorieIntake = calculateCalorieIntake;
